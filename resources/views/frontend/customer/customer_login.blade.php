                        ...
                        <form class="wpo-accountWrapper" action="{{ route('customer.logged') }}" method="POST">
                            ...
                            <div class="wpo-accountInfo">
                                <div class="wpo-accountInfoHeader">
                                    <a href="{{ route('index') }}"><img src="{{ asset('frontend') }}/images/logo-2.svg" alt=""></a>
                            ...
                            <div class="wpo-accountForm form-style">
                                <div class="fromTitle">
                                    ...
                                    @endif
                                    @if (session('email_varify'))
                                        <div class="alert alert-success">
                                            <span>{{ session('email_varify') }}</span>
                                            <a href="{{ route('email.varification.reset') }}">Resent varifation link</a>
                                        </div>
                                    @endif
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group mt-4 mb-4">
                                        <div class="captcha d-flex justify-content-center border-1">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        @error('captcha')
                                            <strong class="text-danger"> Captcha is required</strong>
                                        @enderror
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-12">
