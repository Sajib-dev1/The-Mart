...
@endphp
    <header class="clearfix">
      <div id="logo">
        <img src="https://i.postimg.cc/xqrLGyHm/270x270.png">
      </div>
      <div id="company">
        <h2 class="name">Themart Limited companny</h2>
        <div>Dhanmondi Dhaka,1205</div>
        <div>(602) 519-0450</div>
        <div><a href="mailto:company@example.com">themart@gmail.com</a></div>
      </div>
      </div>
    </header>
    <main>
      <div id="details" class="clearfix">
        <div id="client">
          ...
          <div class="address">{{ $bill->address }}, {{ $bill->city }}, {{ $bill->country }}</div>
