        ...
        <!-- end preloader -->
             ...
             <div class="tp-login-area">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <form class="tp-accountWrapper" action="{{ route('email.resed.request') }}" method="POST">
                                @csrf
                                ...
                                <div class="tp-accountForm form-style">
                                    <div class="fromTitle">
                                        <h2>Resed Email Varification</h2>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-12">
                                            ...
                                            @enderror
                                            @if (session('noexists'))
                                                <strong class="text-danger">{{ session('noexists') }}</strong>
                                            @endif
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-12">
                                            <button type="submit" class="tp-accountBtn">Resend Email</button>
                                        </div>
                                    </div>
